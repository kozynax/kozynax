...
{
    /// <summary>
    /// Terminal host for the Kozui <see cref="MemoryMap"/> tool window.
    /// </summary>
    public sealed class TerminalMemoryMapView : IMemoryMapView
    {
        private readonly ITerminal _terminal;
        private MemoryMap _ui;
        private bool _loopActive;
        private bool _closeRequested;

        public TerminalMemoryMapView(ITerminal terminal)
        {
        ...
        {
            _ui?.Close();
            _ui = new MemoryMap(mem ?? throw new ArgumentNullException(nameof(mem)));
